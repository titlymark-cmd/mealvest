/** Shared formatting helpers for the admin dashboard screens. */
import { COLORS } from "../../styles/theme";

// Deterministic (not random) per-hotel badge color — same hash approach
// used on the student HotelListScreen, so a given hotel gets the same
