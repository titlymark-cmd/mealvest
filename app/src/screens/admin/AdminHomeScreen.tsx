...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontFamily: FONTS.displayBold, fontSize: 15, color: COLORS.text, marginTop: 16, marginBottom: 10 },
  ...
  addBtn: { flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "#EFF9FF", borderRadius: RADIUS.sm, paddingVertical: 8, paddingHorizontal: 12 },
  ...
  commissionInput: { borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.sm, paddingHorizontal: 8, paddingVertical: 4, fontSize: 11, fontFamily: FONTS.bodyMedium, color: COLORS.text, width: 50 },
